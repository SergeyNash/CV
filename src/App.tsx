...
╚════════════════════════════════════════════════╝`
  },
  {
    ...
    path: '/about.txt',
    type: 'file',
    content: `Привет! Меня зовут Сергей Синяков
Я Product Manager с 8+ годами опыта

[ФОТО: sergey-photo.png]
...
ФИЛОСОФИЯ:
"Лучший продукт - тот, который решает реальную проблему пользователя лучше, чем он мог себе представить"

СУПЕРСИЛА:
Превращаю хаос в четкую продуктовую стратегию и запускаю MVP за 6 недель

В ЦИФРАХ:
• 23 успешно запущенных продукта
• 300%+ рост выручки в среднем  
• 50+ человек в управлении
• 95% retention в командах
